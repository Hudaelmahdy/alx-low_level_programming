...
*Return: pointer or NULL if malloc failed.
*/
...
/**
*set_spair - mallocs a key/value pair to table.
*@key: string
...
/**
*update_value - updates the value of node.
*@node: pointer
*@value: string
...
/**
*slist_set_first - sets the first addition to list.
*@ht: pointer to table.
...
/**
*shash_table_set - adds or updates an element to table.
*@ht: pointer to table.
*@key:string
* @value: the value associated with the key
